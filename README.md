# Multi-Mood-Classifier: Multi-Label Emotion Classification
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/1Zi7IPDigQ8BZ3jAsMMhz9CKGHFfgmqg-#scrollTo=7NLoqDmUns9J)

**Instructions:**
1. Click the "Open In Colab" badge above.
2. Once the notebook is loaded, navigate to the **Runtime** menu and select **Run all**.
